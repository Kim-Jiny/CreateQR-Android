...
class WiFiTypeView @JvmOverloads constructor(
    ...
    companion object {
        private val securityTypes = arrayOf("WPA/WPA2", "WEP", "None")
    }
    ...
    override fun setupInputView() {
        ...
        inputBinding.spinnerSecurity.setAdapter(adapter)
        inputBinding.spinnerSecurity.setText(securityTypes[0], false)
    }
    ...
    override fun getQRData(): String {
        ...
        val selectedSecurity = inputBinding.spinnerSecurity.text.toString()
        val securityType = when (selectedSecurity) {
            "WPA/WPA2" -> "WPA"
            "WEP" -> "WEP"
            else -> "nopass"
        }
